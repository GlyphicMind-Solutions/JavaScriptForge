# /JavaScriptForge/engine/deep_analysis.py
# JavaScriptForge Deep Analysis Engine
...
class DeepAnalysisEngine:
    """
    Deep Analysis Engine v2 for JavaScriptForge
...
# =============================== #
    ...
    def summarize_chunk(self, chunk: str, index: int, total: int) -> str:
        topic = (
            "Summarize this JavaScript code for later reconstruction. "
            "Focus on functions, classes, modules, logic flow, and relationships:\n\n"
            f"{chunk}"
        )
    ...
    def merge_summaries(self, summaries: List[str]) -> str:
        ...
        topic = (
            "Merge these JavaScript code summaries into a single, coherent project summary. "
            "Describe modules, functions, classes, dependencies, and architecture:\n\n"
            f"{joined}"
        )
    ...
    def analyze_from_summary(self, meta_summary: str) -> str:
        topic = (
            "Using ONLY this project summary, reconstruct or refactor the JavaScript code. "
            "Preserve logic, improve structure, ensure correctness, and output ONLY JavaScript code:\n\n"
            f"{meta_summary}"
        )
