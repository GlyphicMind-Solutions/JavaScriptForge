# gui/jsforge_window.py
# JavaScriptForge GUI Window (Tabbed IDE Layout)
...
# =======================================
# JSFORGE WINDOW CLASS
# =======================================
class JSForgeWindow(QMainWindow):
    """
    JavaScriptForge GUI (Tabbed IDE Layout)
    ...
    def __init__(self, llm_engine, storage_root: Path, parent=None):
        ...
        self.setWindowTitle("JavaScriptForge — JS Script Forge")
    ...
    def _build_ui(self):
        ...
        self.extracted_code_edit.setPlaceholderText(
            "Extracted JavaScript code from LLM output and Deep Analysis will appear here.\n"
...
# ==================================================================
    ...
    def _on_generate_clicked(self):
        ...
        if not topic:
            QMessageBox.warning(self, "JavaScriptForge", "Please enter a forge topic.")
            return
    ...
    def _on_rerun_clicked(self):
        ...
        if not topic and not self._last_topic:
            QMessageBox.warning(self, "JavaScriptForge", "No topic available.")
            return
    ...
    def _on_approve_clicked(self):
        ...
        if not code:
            QMessageBox.warning(self, "JavaScriptForge", "No code in Master Code.")
            return
    ...
    def _on_save_clicked(self):
        ...
        if not code.strip():
            QMessageBox.warning(self, "JavaScriptForge", "No code to save.")
            return
    ...
    def _on_open_clicked(self):
        ...
        try:
            ...
            QMessageBox.critical(self, "JavaScriptForge", f"Failed to open file: {e}")
            return
    ...
    def _on_deep_analysis_clicked(self):
        code = self.master_code_edit.toPlainText().strip()
        if not code:
            QMessageBox.warning(self, "JavaScriptForge", "No code to analyze.")
            return
        ...
        if not corrected or not corrected.strip():
            QMessageBox.warning(self, "JavaScriptForge", "Deep Analysis produced no corrected code.")
            return
    ...
    def _run_forge(self, topic: str, use_feedback: bool):
        ...
        if not code:
            self.status_label.setText("No valid JS code found.")
            QMessageBox.warning(self, "JavaScriptForge", "No valid JS code found.")
            return
